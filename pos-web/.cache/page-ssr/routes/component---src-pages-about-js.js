...
const AboutPage = () => {
  ...
  }, "Misi Kami: ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    className: "text-primary"
  }, "Digitalisasi UMKM")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
    className: "text-xl text-slate-400"
  }, "Menyediakan akses teknologi kasir enterprise untuk setiap lapisan pengusaha di Indonesia.")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "grid grid-cols-1 md:grid-cols-2 gap-8"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "p-8 rounded-3xl bg-[#192d33] border border-white/10 space-y-4"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    className: "material-symbols-outlined text-4xl text-primary"
  }, "psychology"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3", {
    className: "text-xl font-bold text-white"
  }, "Visi Kami"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
    className: "text-slate-400 leading-relaxed"
  }, "Menjadi platform POS nomor satu yang paling mudah digunakan dan paling andal bagi seluruh pengusaha retail dan F&B di Asia Tenggara.")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "p-8 rounded-3xl bg-[#192d33] border border-white/10 space-y-4"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    className: "material-symbols-outlined text-4xl text-primary"
  }, "rocket_launch"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3", {
    className: "text-xl font-bold text-white"
  }, "Misi Kami"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
    className: "text-slate-400 leading-relaxed"
  }, "Membangun ekosistem bisnis digital yang sederhana namun kuat untuk membantu pemilik bisnis menghemat waktu dan meningkatkan profit."))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "space-y-8"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", {
    className: "text-3xl font-bold text-white border-l-4 border-primary pl-6 flex items-center gap-4"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    className: "material-symbols-outlined text-primary"
  }, "history_edu"), "Cerita Di Balik POS Stream"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "space-y-6 text-lg text-slate-400 leading-relaxed"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, "Didirikan pada tahun 2024, POS Stream lahir dari observasi kami terhadap sulitnya pengusaha kecil mengelola laporan keuangan dan stok secara manual."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, "Kami meyakini bahwa teknologi tidak seharusnya menjadi penghalang bagi bisnis untuk berkembang. Itulah mengapa kami fokus pada pengembangan antarmuka yang intuitif dan sistem cloud yang tangguh.")))))));
};
