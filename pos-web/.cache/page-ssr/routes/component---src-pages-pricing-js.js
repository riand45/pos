exports.id = "component---src-pages-pricing-js";
exports.ids = ["component---src-pages-pricing-js"];
exports.modules = {
...
/***/ "./src/pages/pricing.js?export=default":
/*!*********************************************!*\
  !*** ./src/pages/pricing.js?export=default ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const PricingPage = () => {
  const plans = [{
    name: "Gratis",
    price: "0",
    features: ["1 User", "Ganti Logo Struk", "Laporan Harian", "Max 50 Produk"],
    popular: false
  }, {
    name: "Pro UMKM",
    price: "25rb",
    features: ["Unlimited Produk", "Laporan Laba Rugi", "Multi-User", "Manajemen Stok", "Support 24/7"],
    popular: true
  }, {
    name: "Enterprise",
    price: "Custom",
    features: ["Multi-Cabang", "Integrasi API", "White-label App", "Training On-site"],
    popular: false
  }];
  ...
  }, "Investasi Cerdas untuk Bisnis Anda"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
    className: "text-xl text-slate-400 max-w-3xl mx-auto"
  }, "Pilih paket yang paling sesuai dengan skala usaha Anda.")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "grid grid-cols-1 md:grid-cols-3 gap-8"
  }, plans.map((p, i) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    key: i,
    className: `p-10 rounded-[32px] flex flex-col items-center text-center transition-all ${p.popular ? 'bg-gradient-to-br from-primary to-blue-700 border-none shadow-2xl shadow-primary/30 scale-105 z-10' : 'bg-[#192d33] border border-white/10'}`
  }, p.popular && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    className: "bg-white/20 text-white text-xs font-black uppercase tracking-widest px-4 py-1 rounded-full mb-6"
  }, "Paling Populer"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3", {
    className: `text-2xl font-bold mb-4 ${p.popular ? 'text-background-dark' : 'text-white'}`
  }, p.name), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: `text-5xl font-black mb-8 flex items-baseline gap-1 ${p.popular ? 'text-background-dark' : 'text-white'}`
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    className: "text-lg font-bold opacity-70"
  }, "Rp"), " ", p.price, " ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    className: "text-lg font-bold opacity-70"
  }, p.price !== 'Custom' ? '/bln' : '')), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul", {
    className: "space-y-4 mb-10 text-left w-full"
  }, p.features.map((f, j) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", {
    key: j,
    className: `flex items-center gap-3 text-sm font-medium ${p.popular ? 'text-background-dark/80' : 'text-slate-400'}`
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    className: `material-symbols-outlined text-lg ${p.popular ? 'text-background-dark' : 'text-primary'}`
  }, "check_circle"), f))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", {
    href: "/contact",
    className: `w-full py-4 rounded-xl font-black transition-all ${p.popular ? 'bg-background-dark text-white hover:opacity-90' : 'bg-primary text-background-dark hover:bg-primary/90'}`
  }, "Pilih Paket")))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
    className: "text-center mt-12 text-slate-500 text-sm font-medium"
  }, "Trial 14 hari gratis tanpa kartu kredit untuk semua paket."))));
};
...
;
//# sourceMappingURL=component---src-pages-pricing-js.js.map